...
## 4. 開発ルール
- **設定ファイル**: プロジェクトルートの `GEMINI.md` を**絶対的なルール**として参照すること。
...
- **テスト計画**: 実装計画 (`implementation_plan.md`) 作成時に必ず `docs/test_plan.md` を確認し、新規機能や変更点に対応するテストケースを追加・更新すること。

## 5. 次に取り組むべきタスク (Next Actions)
`TODO.md` に記載されている以下の機能追加が求められています。
